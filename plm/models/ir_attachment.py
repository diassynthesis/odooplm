...
#         defaults['file_size'] = filesize
    ...
    def _search(self, args, offset=0, limit=None, order=None, count=False, access_rights_uid=None):
        ...
        # Without this FIX, after logging in with "PLM BOX Client" to my Odoo V13 instance, I lost access to my Odoo Login Page. Only the access to the home page remains accessible.
    ...
    def saveSingleLevel(self, clientArg):
        ...
        #  generate component
        product_product_id = self.env['product.product'].createFromProps(component_props, ir_attachment_id)
